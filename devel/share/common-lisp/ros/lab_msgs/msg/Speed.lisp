...
(cl:defmethod cl:initialize-instance :after ((m <Speed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Speed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab_msgs-msg:<Speed> is deprecated: use lab_msgs-msg:Speed instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Speed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lab_msgs-msg:data-val is deprecated.  Use lab_msgs-msg:data instead.")
  (data m))
